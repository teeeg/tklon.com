...
configure :build do
  # expire cached assets on update. responsive image variants are content-hashed
  # by scripts/build-images.mjs (filename embeds the hash), so they don't need
  # Middleman's asset_hash on top — ignore the images/ tree.
